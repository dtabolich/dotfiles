...
```sh
git clone https://github.com/dtabolich/dotfiles.git
cd dotfiles
```
...
- **Username**: run `./bootstrap.sh` (it detects your macOS username and offers to set it) OR change the single `user = "dtabolich"` line in `flake.nix`.
